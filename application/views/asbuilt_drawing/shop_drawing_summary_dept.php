        ...
        <div class="card-header">
            ...
            <div class="btn-actions-pane-right">
                <?php if ($this->edit_role) { ?>
                    <button class="btn btn-square btn-primary btn-sm btn-add-asbuilt-drawing-form"><i class="fa fa-plus-circle"></i> New Shop Drawing</button>
                <?php } ?>
            </div>
        </div>
        <div class="card-body">
            ...
            <tbody>
                <?php foreach ($material->result_array() as $row) { ?>
                    <tr>
                        ...
                        <td><?= $row['ur']; ?></td>                                          
                        <td>
                            <a href='#' class="viewAsbuiltDrawingDetailsDept" data-project="<?= $row['project'] ?>" data-department="<?= $row['department'] ?>">
                                View
                            </a>
                        </td>
                    </tr>
