<div class="col-md-12">
    <div class="main-card mb-3 card">
        <div class="card-header">
            <i class="header-icon lnr-graduation-hat icon-gradient bg-happy-itmeo"> </i>Update Material Submittal              
        ...
        <form method="post" class="materialLogUpdateForm" action="">
            <div class="card-body">            
                ...
                <?php foreach ($material->result() as $row) { ?>                    
                    <div class="col-md-12">                    
                        <label for="material" class="col-form-label">Material Details</label>                        
                            ...
                            <input type="hidden" name="material" id="material" value="<?= $row->material ?>" readonly="true" />
