<div class="container text-center mt-3">
    ...
    <form method="post" action="<?= base_url() ?>admin/add_material_submital_log">                    
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="planned_sub_date" id="planned_sub_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="act_sub_date" id="act_sub_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="appr_req_date" id="appr_req_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="appr_date" id="appr_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="rev1_date" id="rev1_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="rev1_appr_date" id="rev1_appr_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="rev2_date" id="rev2_date" class="form-control"/>
        ...
        <div class="form-group row">                    
            ...
            <div class="col-sm-6">
                <input type="text" name="rev2_appr_date" id="rev2_appr_date" class="form-control"/>
        ...
        <div class="form-group">
            <input type="submit" name="submit" class="btn btn-primary full-blue" value="Add Material Submital"/>
        </div>                
    </form>
</div>
<script>
